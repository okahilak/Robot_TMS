...
def get_config():
    ...
    press_key_before_movement = os.getenv('PRESS_KEY_BEFORE_MOVEMENT').lower() == 'true'
    ...
    config = {
        ...
        'press_key_before_movement': press_key_before_movement,
    }
