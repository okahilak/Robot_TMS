...
class RobotStateController:
    ...
    def __init__(self, robot, config):
        ...
        self.press_key_before_movement = config['press_key_before_movement']

        self.state = RobotState.READY if not self.press_key_before_movement else RobotState.WAITING_FOR_KEYPRESS
